...
For example, the new cases and deaths experience to date for Spain is:
![UK_cases_deaths](https://github.com/greenwoodmark/covid19/blob/master/latest/SPAIN_cases_deaths.png)
...
![UK_survival](https://github.com/greenwoodmark/covid19/blob/master/latest/SPAIN_survival.png)
![UK_probabilities](https://github.com/greenwoodmark/covid19/blob/master/latest/SPAIN_probabilities.png)

## Projected new cases and deaths
The fitted projection for the model is then: 
![UK](https://github.com/greenwoodmark/covid19/blob/master/latest/SPAIN.png)

## Weekday reporting patterns
This projection shows a characteristic weekday reporting pattern:
![UK_daily_seasonality](https://github.com/greenwoodmark/covid19/blob/master/latest/SPAIN_daily_seasonality.png)
